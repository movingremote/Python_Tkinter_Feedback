...
class Feedback:
    ...
    def __init__(self, master):  
        ...
        self.logo = PhotoImage(file = "/Users/cecilee/PythonProjects/Ex_Files_Python_Tkinter/Exercise Files/Ch08/tour_logo.gif")
        ttk.Label(self.frame_header, image = self.logo).grid(row = 0, column = 0, rowspan = 2)
        ttk.Label(self.frame_header, text = "Thanks for Exploring!", style = "Header.TLabel").grid(row = 0, column = 1)
        ttk.Label(self.frame_header, wraplength = 300, 
                  text = ("We're glad you choose Explore California for your recent adventure.  "
        ...
        ttk.Button(self.frame_content, text = 'Submit', command = self.sumbit).grid(row = 4, column = 0, padx = 5, sticky = 'e')
